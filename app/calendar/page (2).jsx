...
export default function Calendar() {
  ...
  const labs = [
    { name: 'Physics Lab 1', color: '#C0392B', category: 'Physics' },
    { name: 'Physics Lab 2', color: '#E74C3C', category: 'Physics' },
    { name: 'Chemistry Lab 1', color: '#1A6BB5', category: 'Chemistry' },
    { name: 'Chemistry Lab 2', color: '#2E86DE', category: 'Chemistry' },
    { name: 'Biology Lab 1', color: '#1E8449', category: 'Biology' },
    { name: 'Biology Lab 2', color: '#27AE60', category: 'Biology' },
  ];

  const btcRow = { name: 'BTC', label: 'Bring to Class', color: '#B8860B', category: 'BTC' };
